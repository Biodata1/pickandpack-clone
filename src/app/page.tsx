            ...
            <Reveal direction="left" className={styles.promoContent}>
              ...
              <MagneticButton>
                <a
                  ...
                  onClick={() => trackLead({ nama: 'Pengunjung Anonim', nomor_wa: '-', produk: 'Promo UMKM', tipe_lead: 'wa_click' })}
                >
                  Ambil Promo Ini
                </a>
              </MagneticButton>
            ...
            <div className={styles.ctaButtons}>
              <MagneticButton>
                <a
                  ...
                  onClick={() => trackLead({ nama: 'Pengunjung Anonim', nomor_wa: '-', produk: 'Custom Packaging (CTA Section)', tipe_lead: 'wa_click' })}
                >
              ...
              <div className={styles.finalCtaBtns}>
                <MagneticButton>
                  <a
                    ...
                    onClick={() => trackLead({ nama: 'Pengunjung Anonim', nomor_wa: '-', produk: 'Konsultasi Gratis (Final CTA)', tipe_lead: 'wa_click' })}
                  >
                    Konsultasi Gratis
                  </a>
                </MagneticButton>
