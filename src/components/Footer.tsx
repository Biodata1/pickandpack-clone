          ...
          <div className={styles.grid}>
            ...
            <div className={styles.brand}>
              ...
              <div className={styles.socialIcons}>
                <a
                  href="https://wa.me/6285777237523"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="WhatsApp"
                  onClick={() => {
                    trackGAEvent('wa_cta_click', { source: 'footer_social' });
                    trackLead({ nama: 'Pengunjung Anonim', nomor_wa: '-', produk: 'Konsultasi Umum (Footer)', tipe_lead: 'wa_click' });
                  }}
                >
                ...
                <a href="https://www.instagram.com/printwork.idn/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                ...
                <a href="mailto:printworkmultigraph@gmail.com" aria-label="Email">
            ...
            <div className={styles.linkGroup}>
              ...
              <ul className={styles.contactList}>
                <li>
                  ...
                  <span>Jl. Kalibaru Timur Dalam No.1 no 30, RT.6/RW.6, Poncol, Bungur, Kec. Senen, DKI Jakarta 10460</span>
                </li>
                <li>
